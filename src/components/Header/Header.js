            ...
            <OutSide>
                <PosterContainer>
                    ...
                    <MenuContainer>
                        ...
                        <BlogSearchContainer onClick={openModal}>旅遊故事</BlogSearchContainer>
                        <AirplaneSearchContainer onClick={openModal}>航班狀態</AirplaneSearchContainer>
                        <RouteSearchContainer onClick={openModal}>路線搜尋</RouteSearchContainer>
                    </MenuContainer>
                </PosterContainer>
            </OutSide>
            {modalIsOpen ? (
